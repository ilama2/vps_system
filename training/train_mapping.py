...
map_code = torch.nn.Parameter(torch.randn(1, 64, 768)).to(device)

optimizer = torch.optim.Adam(
    list(regressor.parameters()) + [map_code], lr=1e-4
)
...
for epoch in range(5):
    ...
    print("Mapping Epoch:", epoch, loss.item())

torch.save(map_code, "map_code.pth")